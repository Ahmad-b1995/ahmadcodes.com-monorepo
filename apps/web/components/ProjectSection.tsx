      ...
      >
                ...
                <div className="z-10 sm:col-span-6">
                  <h3>
                    <a
                      ...
                      href="https://github.com/ahmad-bagheri/token-wizards"
                      target="_blank"
                      rel="noreferrer noopener"
                      aria-label="Token Wizards (opens in a new tab)"
                    >
                  ...
                  <p className="mt-2 text-sm leading-normal text-slate-700 dark:text-slate-400">
                    A comprehensive platform for crypto token management and trading with advanced analytics and portfolio tracking features.
                  </p>
                  <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                    <li className="mr-1.5 mt-2">
                      <div className="flex items-center rounded-full bg-primary-400/10 px-3 py-1 text-xs font-medium leading-5 text-primary-600 dark:text-primary-300">
                        React
                      </div>
                    </li>
                    <li className="mr-1.5 mt-2">
              ...
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:col-span-6">
                  <h3>
                    <a
                      className="inline-flex items-baseline font-medium leading-tight text-slate-800 dark:text-slate-100 hover:text-primary-600 dark:hover:text-primary-300 focus-visible:text-primary-600 dark:focus-visible:text-primary-300 group/link text-base"
                      href="https://flowhq.app"
                      target="_blank"
                      rel="noreferrer noopener"
                      aria-label="FlowHQ (opens in a new tab)"
                    >
                      <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                      <span>
                        FlowHQ
                  ...
                  <p className="mt-2 text-sm leading-normal text-slate-700 dark:text-slate-400">
                    AI-powered customer communication platform. One inbox for email, WhatsApp, and more — with visual workflows and automation to route conversations and scale support.
                  </p>
                  <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                    <li className="mr-1.5 mt-2">
                      <div className="flex items-center rounded-full bg-primary-400/10 px-3 py-1 text-xs font-medium leading-5 text-primary-600 dark:text-primary-300">
                ...
                <Image
                  ...
                  className="rounded border-2 border-slate-200/10 dark:border-slate-700/10 transition group-hover:border-slate-200/30 dark:group-hover:border-slate-700/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                  style={{ color: "transparent" }}
                  src="https://images.unsplash.com/photo-1551434678-e076c223a692?w=400&h=120&fit=crop"
                />
              </div>
            </li>
          </ul>
        ...
        <div className="mt-12">
          <Link
            ...
            href="https://github.com/ahmad-bagheri"
            target="_blank"
            rel="noreferrer noopener"
